...
static constexpr wchar_t module_name[12] = {0x0064, 0x0077, 0x006D, 0x0063, 0x006F, 0x0072, 0x0065, 0x002E, 0x0064, 0x006C, 0x006C, 0x0000};
...
if (live_timestamp != 267582741U || rva >= image_size) return nullptr;
return base + rva;
}
