//! Windissect-generated Rust FFI bindings for dwmcore.dll. Windows only.
...
pub const EXPECTED_PDB_GUID: &str = "245D863552568E69CD9C8C4FD23F23D8";
pub const EXPECTED_PDB_AGE: u32 = 1;
pub const EXPECTED_PE_TIMESTAMP: u32 = 267582741;
...
mod resolver {
    ...
    pub fn base() -> usize {
        ...
        let name: [u16; 12] = [100, 119, 109, 99, 111, 114, 101, 46, 100, 108, 108, 0];
        ...
        if live_timestamp != 267582741 { return 0; }
